  ...
  Drupal.behaviors.firjan_mercadolivre = {
    attach: function (context, settings) {
      $(window).on('load', function () {
        ...
        async function listTaxonomies(url) {
          $.ajax({
              type: "GET",
              url: url,
        ...
        const getTaxonomies = async (url) => {
          const response = await listTaxonomies(url).then(data => {
              return data          
        ...
        setTimeout(() => {
          ...
          $(document).on('submit','form.cpf',function(e) {
            ...
            console.log(getTaxonomies('/jsonapi/taxonomy_term/whitelist?fields[whitelist--name]=name&sort=name&page[limit]=50'))
