      ...
      var init = function() {
              ...
              if(isAvailable(cnpjs.flat())) {
                ...
                let html = `
                  <div id="cnpj-first-validate" class="form-item--error-message mt-2">
                    O CNPJ <em class="placeholder">${submitedVal}</em> não é válido na nossa base de dados.
                  </div>
                `;
        ...
        $(document).on('submit','form.cpf',function(e) {
          if(document.querySelectorAll('#cnpj-first-validate').length) {
            document.querySelectorAll('#cnpj-first-validate').prototype.forEach.call( element, function( node ) {
