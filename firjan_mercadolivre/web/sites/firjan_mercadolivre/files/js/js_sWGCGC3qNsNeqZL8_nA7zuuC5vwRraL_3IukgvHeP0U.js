      ...
      $(window).on('load', function () {
        ...
        setTimeout(() => {
          ...
          $(document).on('submit','form.cpf',function(e) {
            ...
            // getTaxonomies('/jsonapi/taxonomy_term/whitelist?fields[whitelist--name]=name&sort=name&page[limit]=50').then(data => {
            //   console.log(data)
            // }).catch(error => alert(error));

            console.log($.ajax({
                url: '/jsonapi/taxonomy_term/whitelist?fields[whitelist--name]=name&sort=name&page[limit]=50'
            }))            
